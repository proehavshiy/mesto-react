class FormValidator {
  constructor(form) {
    this._form = form;
    this._inputList = Array.from(this._form.querySelectorAll('.popup__input')); //массив всех инпутов из формы
  ...
  _showInputError(_inputElement) {
    ...
    //находим span ошибки
    const _errorElement = this._form.querySelector(`.${'popup__input_error'}${_inputElement.name}`);
